...
class PretrainedModelJob(Job):
    ...
    def has_weights(self):
        return os.path.isfile(self.get_filters_path())
    ...
    def __getstate__(self):
        fields_to_save = ['_id', '_name', 'username', 'tasks', 'status_history', 'has_labels', 'framework', 'image_info', 'pickver_pretrained_job']
