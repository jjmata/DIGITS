...
class Visualization(VisualizationInterface):
    ...
    def process_data(self, input_id, input_data, output_data):
        ...
        grad = np.array([output_vector[0] * self.width, output_vector[1] * self.height])
        ...
        draw.line((at_acw[0],at_acw[1],arrow_tip[0],arrow_tip[1]), fill=self.color)
        draw.line((at_cw[0],at_cw[1],arrow_tip[0],arrow_tip[1]), fill=self.color)
        draw.line((at_acw[0],at_acw[1],at_cw[0],at_cw[1]), fill=self.color)
